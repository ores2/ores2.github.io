...
///////////////////////////////////////////////////////////////////
  ...
  **/
  function fixFileName($string){
    $string = strtr ( $string, "АБВГДЕабвгдеТУФХЦШтуфхцшИЙКЛийклЗзМНОПмнопЩЪЫЬщъыьяСс", "AAAAAAaaaaaaOOOOOOooooooEEEEeeeeCcIIIIiiiiUUUUuuuuyNn");
  ...
  **/
  function checkUploadConditions(){
    ...
    foreach($this->supported_extensions as $each_ext => $type)
      if(strtolower($each_ext) == strtolower($ext) && $this->type == $type || $this->type="application/octet-stream") $allow = TRUE;
    }
    else
    {
     $allow = TRUE;
